...
class TestAttribute(util.TestCase):
    ...
    def test_attribute(self):
        ...
        self.assert_selector(self.MARKUP, "[href]", ["2"], flags=util.HTML)
    ...
    def test_attribute_equal_no_quotes(self):
        ...
        # No quotes
        self.assert_selector(self.MARKUP, "[id=\\35]", ["5"], flags=util.HTML)

    def test_attribute_equal_with_quotes(self):
        """Test attribute with value that equals specified value (with quotes)."""

        # Single quoted
        self.assert_selector(self.MARKUP, "[id='5']", ["5"], flags=util.HTML)
    ...
    def test_attribute_escaped_newline(self):
        ...
        self.assert_selector(self.MARKUP, '[id="pr\\\ne"]', ["pre"], flags=util.HTML)
    ...
    def test_attribute_type_html(self):
        ...
        self.assert_selector(markup, '[type="test"]', ["0", "2"], flags=util.HTML)
    ...
    def test_attribute_type_xml(self):
        ...
        self.assert_selector(markup, '[type="test"]', ["2"], flags=util.XML)
    ...
    def test_attribute_type_xhtml(self):
        ...
        self.assert_selector(markup, '[type="test"]', ["2"], flags=util.XHTML)
    ...
    def test_attribute_contains_cannot_have_empty(self):
        ...
        self.assert_selector(self.MARKUP_CONTAINS, '[class~=""]', [], flags=util.HTML)
    ...
    def test_none_inputs(self):
        ...
        soup = CS("<span>text</span>", "html.parser")
        soup.span["foo"] = None
    ...
    def test_nested_sequences(self):
        """Nested sequences will crash and burn due to the way CS handles them."""
