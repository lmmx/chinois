...
class TestDir(util.TestCase):
    ...
    def test_dir_ltr(self):
        ...
        self.assert_selector(self.MARKUP, "div:dir(ltr)", ["3"], flags=util.HTML)

    def test_dir_conflict(self):
        """Test conflicting direction."""

        self.assert_selector(self.MARKUP, "div:dir(ltr):dir(rtl)", [], flags=util.HTML)

    def test_dir_xml(self):
        """Test direction with XML (not supported)."""

        self.assert_selector(self.MARKUP, "div:dir(ltr)", [], flags=util.XML)
    ...
    def test_dir_bidi_detect(self):
        ...
        self.assert_selector(self.MARKUP, "span:dir(ltr)", ["8"], flags=util.HTML)
    ...
    def test_dir_on_root(self):
        ...
        self.assert_selector(self.MARKUP, "html:dir(ltr)", ["0"], flags=util.HTML)
    ...
    def test_dir_auto_root(self):
        ...
        self.assert_selector(markup, "html:dir(ltr)", ["0"], flags=util.HTML)
    ...
    def test_iframe(self):
        ...
        self.assert_selector(markup, "div:dir(ltr)", ["1"], flags=util.PYHTML)

        self.assert_selector(markup, "div:dir(rtl)", ["2"], flags=util.PYHTML)
    ...
    def test_xml_in_html(self):
        ...
        self.assert_selector(markup, "div:dir(ltr)", ["1"], flags=util.HTML5)

        self.assert_selector(markup, "div:dir(rtl)", [], flags=util.HTML5)

        self.assert_selector(markup, "math:dir(rtl)", [], flags=util.HTML5)
