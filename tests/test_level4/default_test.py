...
class TestDefault(util.TestCase):
    ...
    def test_iframe(self):
        ...
        self.assert_selector(markup, ":default", ["d1", "d3", "d4"], flags=util.PYHTML)
    ...
    def test_nested_form(self):
        ...
        self.assert_selector(markup, ":default", ["d1"], flags=util.HTML)
    ...
    def test_default_cached(self):
        ...
        self.assert_selector(markup, ":default:default", ["d1"], flags=util.HTML)
    ...
    def test_nested_form_fail(self):
        ...
        self.assert_selector(markup, ":default", [], flags=util.HTML)
