...
class TestHas(util.TestCase):
    ...
    def test_has_subsequent_sibling(self):
        ...
        self.assert_selector(self.MARKUP, "p:has(~ .jjjj)", ["7", "8"], flags=util.HTML)

    def test_has_child(self):
        """Test has2."""

        self.assert_selector(self.MARKUP2, "div:has(> .bbbb)", ["0"], flags=util.HTML)
    ...
    def test_has_no_match(self):
        ...
        self.assert_selector(self.MARKUP2, "div:has(:paused)", [], flags=util.HTML)
