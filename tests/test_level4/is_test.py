...
class TestIs(util.TestCase):
    ...
    def test_is(self):
        ...
        self.assert_selector(self.MARKUP, ":is(span, a)", ["1", "2"], flags=util.HTML)
    ...
    def test_is_empty(self):
        ...
        self.assert_selector(self.MARKUP, ":is()", [], flags=util.HTML)
    ...
    def test_is_with_other_pseudo(self):
        ...
        self.assert_selector(self.MARKUP, ":is(span):not(span)", [], flags=util.HTML)
    ...
    def test_multiple_is(self):
        ...
        # Each pseudo class is evaluated separately
        # So this will not match
        self.assert_selector(self.MARKUP, ":is(span):is(div)", [], flags=util.HTML)

        # Each pseudo class is evaluated separately
        # So this will match
        self.assert_selector(self.MARKUP, ":is(a):is(#\\32)", ["2"], flags=util.HTML)
