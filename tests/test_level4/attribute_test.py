...
class TestAttribute(util.TestCase):
    ...
    def test_attribute_forced_case_insensitive(self):
        ...
        self.assert_selector(self.MARKUP, "[class*=WORDS]", [], flags=util.HTML)
    ...
    def test_attribute_case_insensitive_flag_spacing(self):
        ...
        self.assert_selector(self.MARKUP, "[class*=WORDSi]", [], flags=util.HTML)
    ...
    def test_attribute_forced_case_insensitive_xml(self):
        ...
        self.assert_selector(self.MARKUP, '[type="test" i]', ["0", "2"], flags=util.XML)
    ...
    def test_attribute_type_case_sensitive(self):
        ...
        self.assert_selector(self.MARKUP, '[type="test" s]', ["2"], flags=util.HTML)
