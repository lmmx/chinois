...
class TestType(util.TestCase):
    ...
    def test_type_html(self):
        ...
        self.assert_selector(self.MARKUP, "tag", ["1", "2", "3"], flags=util.HTML)
    ...
    def test_type_xml(self):
        ...
        self.assert_selector(self.MARKUP, "tag", ["2"], flags=util.XML)

        self.assert_selector(self.MARKUP, "Tag", ["1"], flags=util.XML)

        self.assert_selector(self.MARKUP, "TAG", ["3"], flags=util.XML)
