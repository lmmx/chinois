...
class TestVersion(unittest.TestCase):
    ...
    def test_version_parsing(self):
        ...
        assert parse_version(Version(1, 0, 0, "final")._get_canonical()) == Version(
            1,
            0,
            0,
            "final",
        )
        assert parse_version(Version(1, 2, 0, "final")._get_canonical()) == Version(
            1,
            2,
            0,
            "final",
        )
        assert parse_version(Version(1, 2, 3, "final")._get_canonical()) == Version(
            1,
            2,
            3,
            "final",
        ...
        assert parse_version(Version(1, 2, 3, ".dev")._get_canonical()) == Version(
            1,
            2,
            3,
            ".dev",
