...
class TestNthChild(util.TestCase):
    ...
    def test_nth_child(self):
        ...
        self.assert_selector(markup, "p:nth-child(-2)", [], flags=util.HTML)

        self.assert_selector(markup, "p:nth-child(2)", ["1"], flags=util.HTML)

        self.assert_selector(markup, "p:NTH-CHILD(2)", ["1"], flags=util.HTML)

        self.assert_selector(markup, r"p:NT\H-CH\ILD(2)", ["1"], flags=util.HTML)
    ...
    def test_nth_child_complex(self):
        ...
        self.assert_selector(markup, "p:nth-child(50n-20)", [], flags=util.HTML)

        self.assert_selector(markup, "p:nth-child(-2n-2)", [], flags=util.HTML)

        self.assert_selector(markup, "p:nth-child(9n - 1)", ["7"], flags=util.HTML)
        ...
        self.assert_selector(markup, "p:nth-child(-n+3)", ["0", "1"], flags=util.HTML)

        self.assert_selector(markup, "span:nth-child(-n+3)", ["2"], flags=util.HTML)
